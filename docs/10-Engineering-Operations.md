...
6. Run `verify-deployment-schema.sql` on staging; run smoke tests (`smoke:receipts-confirm`, `smoke:splits`, `smoke:expenses-reset`, `smoke:messages-preview`, `smoke:split-revision`, `smoke:settlement`).
