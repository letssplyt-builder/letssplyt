...
> **Version note:** This version applies when LetsSplyt uses **Telnyx + custom OTP** for SMS delivery.
>
> **No changes from the Twilio version.** The Terms of Service were deliberately written without naming any specific SMS provider. All SMS-related sections (Section 8 — SMS Communications, Section 9 — Third-Party Payment Services) describe user-facing rights and obligations, not implementation details. Switching from Twilio to Telnyx with a custom OTP does not alter any user right, any consent requirement, any opt-out mechanism, any limitation of liability, or any arbitration provision. This document is legally identical to the Twilio version and is provided here for completeness and version tracking only.
...
**PLEASE READ THIS SECTION CAREFULLY. IT AFFECTS YOUR LEGAL RIGHTS REGARDING RECEIVING SMS MESSAGES.**
