...
| ID | Action | Description | Why This Exists |
|----|--------|-------------|-----------------|
| P29 | View Home — net balance hero | Top card: net USD balance (green / red / grey). Calls `GET /users/me/balance`. Same for all users. | One number for total exposure across all events. **MVP** |
