...
| S07 | Push — self-report received | Participant taps "I paid" → optional push to payer (row is already `confirmed`; payer may dispute if needed). | Legacy confirm step removed for app self-report; dispute remains for verification. |
